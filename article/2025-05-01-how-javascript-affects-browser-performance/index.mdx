...
content is added to the page asynchronously by javascript. The first solution you should look at is rendering as much
as you can before first paint, e.g. server or static rendering, but let's explore after first paint.
