...
<figure class="smallest right">
  <Image src={imgSelfAttention} alt="RNN vs Self-attention" />
  <figcaption>
    from [Self-Attention and Positional
    Encoding](https://classic.d2l.ai/chapter_attention-mechanisms/self-attention-and-positional-encoding.html)
  </figcaption>
</figure>
...
<figure class="right">
  <Image src={imgAgentManifest} alt="Frontmatter of a subagent definition" />
...
<figure class="center borderless">
  <Image src={imgAgentDocResearcher} alt="Example usage of a subagent doing research" />
...
2. ~**Lack of concurrency management:** This subagent feature in Claude Code is not meant for managing concurrent
   ...
   you want concurrency orchestration you'll need to manage separate conversations, multiple "subagent" tasks with the
   Task tool, or use some sort of git worktrees + terminal multiplexer + note sharing through the filesystem workflow.~

<div class="alert alert-info">
  **Update**: As I've worked with subagents more I've come to understand them as being a primitive for execution as
  opposed to a concurrency manager themselves. Given that, Claude Code itself can utilize subagents to facilitate
  concurrency as part of Tasks or Swarms. I also use them as a primitive in my own orchestration layer that allows for
  concurrency, [I wrote about it here](/article/2026/03-30-automating-your-agents).
</div>
