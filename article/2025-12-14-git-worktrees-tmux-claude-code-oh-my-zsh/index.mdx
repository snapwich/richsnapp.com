...
image: ./architect.jpg
heroCaption: The Architect in The Matrix monitoring his Claude agents (probably)
---
...
<figure class="smallest right">
  <div style="background: #111; padding: 10px; text-align: center;">
    <Image src={imgContainerClaude} alt="Claude in jail" />
  </div>
...
<figure class="small right borderless center-micro">
  <TmuxDiagram />
</figure>
...
<LightboxGallery selector="img">
  <figure class="center">
    <Image src={imgLazvim} data-src={imgLazvim.src} alt="Screenshot of LazyVim from lazyvim.org" />
...
<Step image={imgWorkflow} alt="Visual example of a worktree session">
...
<figure class="center">
```sh
# create tmux window and worktree named after github PR
# (requires authenticated `gh` cli)
gwtmux 123
# create tmux window, worktree, and branch
# will create branch or checkout if exists local or remote
gwtmux my-local-or-remote-branch
# close tmux window (but leave worktree and branch)
gwtmux -d
# close tmux window and delete worktree
gwtmux -dw
# close tmux window, delete worktree, safe delete branch
gwtmux -dwb # gwtmux -dwB to force delete unmerged branch
# close tmux window, delete worktree, delete branches
# (local and remote)
gwtmux -dwBr
```
</figure>
