...
<template lang="md">
  ...
  2) If you plan to use this Raspberry Pi cluster for doing the The Linux Foundation's Kubernetes Fundamentals (LFS258)
  ...
  1) It can get pretty expensive if you setup a cloud cluster and leave it sitting for any amount of time. To get
