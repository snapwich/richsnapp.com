...
<figure class="right small">
  <Image src={imgCapFrame} alt="CapFrameX results" />
...
<figure class="center">
  <Image src={img3080tiRiser} alt="3080ti frametiming with and without riser cable" />
...
<figure class="right">
  <Image src={imgRiserNoRiser} alt="lian li riser cable versus louqe riser cable" />
...
<figure>
  <Image src={imgDebugging} alt="debugging the build on my test bench" />
...
<figure class="smallest right">
  <Image src={imgCloseShave} alt="a loque riser cable with corners shaved" />
